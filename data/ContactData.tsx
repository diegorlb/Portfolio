export const ExtraTextData = `
  Just so you know, I try to check my mail every day, but there's a tiny chance it might take a while for me to reply,
  but I promise that I'll do it ASAP.
`
